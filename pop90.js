...
adWindow.appendChild(iframe);
    ...
    var utils = {
        ...
        _openAd: function(url, options) {
            // No longer need a semaphore for redirection as we are just calling createFloatingAd
            // nor pre-processing logic for the URL if it's already processed before.
